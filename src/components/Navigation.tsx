...
const Navigation = () => {
  ...
  return (
    <nav
      className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md shadow-elegant transition-all duration-300"
    >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="flex flex-col">
              <span className="text-xl font-bold text-primary leading-none">Four Sight</span>
              <span className="text-xs text-muted-foreground hidden sm:block">Web Solutions</span>
            </div>
          </div>
